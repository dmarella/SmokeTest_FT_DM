...
Feature: Data Creation
  ...
  Scenario: Creating an new ServiceRequest
    ...
    And user fill the new Service Request form
      ...
      | Mr Training | C1000007 | L1000537 | Engineering Training  WO in Dispatch Status  | REACTIVE \ HVAC \ GAS \ NOTWORKG | WO in Dispatch | 01908 4343443   | training@training.com | 12345             | 654321             |
