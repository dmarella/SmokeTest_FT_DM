...
Feature: Data Creation
  ...
  Scenario: Creating an new ServiceRequest
    ...
    And user fill the new Service Request form
      ...
      | Mr Training | C1000011 | L1001455 | WFM Training WO in WSCH | REACTIVE \ BUILDING FABRIC \ PAINTDEC \ PATCH  | WO in WSCH | 01908 4343443   | training@training.com | 12345             | 654321             |
