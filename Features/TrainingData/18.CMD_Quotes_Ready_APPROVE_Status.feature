...
Feature: Data Creation
  ...
  Scenario: Creating an new ServiceRequest
    ...
    And user fill the new Service Request form
      ...
      | Mr Training | C1000011 | L1001455 | CMD Training - Quotes priced & ready for approval | QUOTE \ FABRIC \ QUOTE2 | Quotes priced & ready for approval | 01908 4343443   | training@training.com | 12345             | 654321             |
