...
Feature: Data Creation
  ...
  Scenario: Creating an new ServiceRequest
    ...
    And user fill the new Service Request form
      ...
      | Mr Training | C1000011 | L1001455 | Customer Support Training  - Quotes returned to ‘PRICING’ status  | QUOTE \ FABRIC \ QUOTE2 | Quotes returned to ‘PRICING’ status from CDM for a revision | 01908 4343443   | training@training.com | 12345             | 654321             |
