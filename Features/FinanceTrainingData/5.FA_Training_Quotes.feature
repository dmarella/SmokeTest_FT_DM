...
Feature: Data Creation
  ...
  Scenario: Creating an new ServiceRequest
    ...
    And user fill the new Service Request form
      ...
      | Mr Training | C1000011 | L1001455 | FA Training-NTE Quotes   | QUOTE \ FABRIC \ QUOTE2 | Quotes ‘Completed’ status (Which should have an auto generated WO) | 01908 4343443   | training@training.com | 12345             | 654321             |
