...
public class PurchaseOrderLinesPage extends WorkOrderPage {
    ...
    public void SelectItemTypeasMaterial() throws InterruptedException {
        Thread.sleep(2000);
    ...
    public void LinkWorkOrderNumber() throws InterruptedException, IOException {
        Thread.sleep(2000);
        FileReader FR = new FileReader("C:\\Users\\dmarella\\IdeaProjects\\FT_ST\\WO.txt");
    ...
    public void PurchaseOrderApprovalMemo() throws InterruptedException {
        Thread.sleep(1000);
        WebDriverWait wait = new WebDriverWait(driver, 60);
    ...
    public static void searchPO(String[] args) throws InterruptedException {
        Thread.sleep(2000);
        WebDriverWait wait = new WebDriverWait(driver, 60);
